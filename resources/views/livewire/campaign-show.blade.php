                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4 grid grid-cols-3 gap-x-6">
                                ...
                                <div class="col-span-3 sm:col-span-1">
                                    ...
                                    @if(isset($campaign->design->logo))
                                        {{ var_dump($campaign->design->logo) }}
                                    @endif
                                    <x-jet-input id="logo" type="file" class="mt-1 block w-full" wire:model.defer="campaign.design.logo" autocomplete="logo" />
                                    <x-jet-input-error for="campaign.design.logo" class="mt-2" />
                                </div>
                                <div class="col-span-3 sm:col-span-1">
                                    <x-jet-label for="background" value="{{ __('Background Image') }}" />
                                    <x-jet-input id="background" type="file" class="mt-1 block w-full" wire:model.defer="campaign.design.background" autocomplete="background" />
                                    <x-jet-input-error for="campaign.design.background" class="mt-2" />
                                </div>
                                <div class="col-span-3 sm:col-span-1">
                                    <x-jet-label for="icon" value="{{ __('Icon') }}" />
                                    <x-jet-input id="icon" type="file" class="mt-1 block w-full" wire:model.defer="campaign.design.icon" autocomplete="icon" />
                                    <x-jet-input-error for="campaign.design.icon" class="mt-2" />
                                </div>
                            </div>
                            <div class="col-span-6 sm:col-span-4 grid grid-cols-3 gap-x-6">
                                ...
                                <div class="col-span-3 sm:col-span-1">
                                    ...
                                    <select id="family" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" wire:model.defer="campaign.design.family" autocomplete="family">
                                        <option>-- Select One --</option>
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                    <x-jet-input-error for="campaign.design.family" class="mt-2" />
                                </div>
                                <div class="col-span-3 sm:col-span-1">
                                    <x-jet-label for="image" value="{{ __('Use images?') }}" />
                                    <select id="image" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" wire:model.defer="campaign.design.image" autocomplete="image">
                                        <option>-- Select One --</option>
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                    <x-jet-input-error for="campaign.design.image" class="mt-2" />
                                </div>
                                <div class="col-span-3 sm:col-span-1">
                                    <x-jet-label for="private" value="{{ __('Force privacy?') }}" />
                                    <select id="private" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" wire:model.defer="campaign.design.private" autocomplete="private">
                                        <option>-- Select One --</option>
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                    <x-jet-input-error for="campaign.design.private" class="mt-2" />
                                </div>
                            </div>
                        </div>
                    </div>
